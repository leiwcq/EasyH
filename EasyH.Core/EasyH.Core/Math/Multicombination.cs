...
namespace EasyH.Core.Math
{
    ...
    /// 
    /// Use the <see cref="P:Common.Math.Multicombination.Item(System.Int32)">indexer</see>
    ...
    ///     <see cref="P:Common.Math.Multicombination.Item(System.Int32)">indexer</see>.
    ///   </li>
    ///   <li>
        ...
        IEnumerable<int>
    {
        ...
        private long _rowCount; // Row count of the table of k-multicombinations.
        ...
        public long Rank
        {
            ...
            set
            {
                ...
                var combinaticAtom = Choices + Picks - 1;
                ...
                for (var ki = Picks; ki > 0; --ki)
                    for (;;)
                    {
                        ...
                        _data[Picks - ki] = Choices - combinaticAtom + ki - 2;
                        break;
                    }
            }
        }
        ...
        public IEnumerable<Multicombination> GetRows()
        {
            ...
            {
                var startRank = _rank;
                for (var current = (Multicombination) MemberwiseClone();;)
                {
        ...
        public static List<T> Permute<T>(Multicombination arrangement, IList<T> source)
        {
            ...
            for (var ei = 0; ei < arrangement.Picks; ++ei)
