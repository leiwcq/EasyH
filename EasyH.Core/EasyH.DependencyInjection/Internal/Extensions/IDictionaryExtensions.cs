...
namespace EasyH.DependencyInjection.Internal.Extensions
{
    /// <summary>
    ...
    internal static class DictionaryExtensions
    {
        ...
        {
            if (dict.Count > 0 && key != null && dict.TryGetValue(key, out TValue value))
            {
                return value;
            }
            return defaultValue;
        ...
        {
            if (dict.Count > 0 && dict.TryGetValue(key, out TValue value))
            {
                return value;
            }
