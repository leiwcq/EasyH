...
namespace EasyH.Core.Text
{
    ...
    public static class ReflectionExtensions
    {
        ...
        {
            if (ConstructorMethods.TryGetValue(type, out EmptyCtorDelegate emptyCtorFn)) return emptyCtorFn;
        ...
        {
            if (TypeNamesMap.TryGetValue(typeName, out EmptyCtorDelegate emptyCtorFn)) return emptyCtorFn;
