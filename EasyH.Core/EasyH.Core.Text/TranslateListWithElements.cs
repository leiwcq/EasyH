...
namespace EasyH.Core.Text
{
    public static class TranslateListWithElements
    {
        ...
        {
            if (TranslateICollectionCache.TryGetValue(toInstanceOfType, out ConvertInstanceDelegate translateToFn))
            ...
            object from, Type toInstanceOfType, Type fromElementType)
        {
            ...
            if (TranslateConvertibleICollectionCache.TryGetValue(typeKey, out ConvertInstanceDelegate translateToFn)) return translateToFn(from, toInstanceOfType);
