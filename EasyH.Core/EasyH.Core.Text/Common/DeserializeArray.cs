...
namespace EasyH.Core.Text.Common
{
        ...
        where TSerializer : ITypeSerializer
    {
        ...
        {
            if (ParseDelegateCache.TryGetValue(type, out ParseArrayOfElementsDelegate parseFn)) return parseFn.Invoke;
        ...
        where TSerializer : ITypeSerializer
    {
        ...
        {
            if (ParseDelegateCache.TryGetValue(type, out ParseStringSegmentDelegate parseFn)) return parseFn;
