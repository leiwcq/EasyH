...
namespace EasyH.Core.Text.Json
{
    public static class JsonWriter
    {
        ...
        internal static WriteObjectDelegate GetWriteFn(Type type)
        {
            try
            {
                if (WriteFnCache.TryGetValue(type, out WriteObjectDelegate writeFn)) return writeFn;
        ...
        internal static TypeInfo GetTypeInfo(Type type)
        {
            try
            {
                if (JsonTypeInfoCache.TryGetValue(type, out TypeInfo writeFn)) return writeFn;
