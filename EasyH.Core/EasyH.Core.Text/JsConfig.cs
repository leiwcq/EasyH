...
namespace EasyH.Core.Text
{
        ...
        JsConfig
    {
        ...
        {
            get => (JsConfigScope.Current?.DateTimeFormat)
                   ?? sDateTimeFormat;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.ConvertObjectTypesIntoStringDictionary)
        ...
        {
            get => (JsConfigScope.Current?.TryToParsePrimitiveTypeValues)
        ...
        {
            get => (JsConfigScope.Current?.TryToParseNumericType)
        ...
        {
            get => (JsConfigScope.Current?.TryParseIntoBestFit)
        ...
        {
            get => (JsConfigScope.Current?.ParsePrimitiveFloatingPointTypes)
        ...
        {
            get => (JsConfigScope.Current?.ParsePrimitiveIntegerTypes)
        ...
        {
            get => (JsConfigScope.Current?.ExcludeDefaultValues)
        ...
        {
            get => (JsConfigScope.Current?.IncludeNullValues)
                   ?? sIncludeNullValues
                   ?? false;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.IncludeNullValuesInDictionaries)
        ...
        {
            get => (JsConfigScope.Current?.IncludeDefaultEnums)
        ...
        {
            get => (JsConfigScope.Current?.TreatEnumAsInteger)
                   ?? sTreatEnumAsInteger
                   ?? false;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.ExcludeTypeInfo)
                   ?? sExcludeTypeInfo
                   ?? false;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.IncludeTypeInfo)
                   ?? sIncludeTypeInfo
                   ?? false;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.TypeAttr)
                   ?? sTypeAttr
                   ?? JsWriter.TypeAttr;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.JsonTypeAttrInObject)
        ...
        {
            get => (JsConfigScope.Current?.JsvTypeAttrInObject)
        ...
        {
            get => (JsConfigScope.Current?.TypeWriter)
                   ?? sTypeWriter
        ...
        {
            get => (JsConfigScope.Current?.TypeFinder)
                   ?? sTypeFinder
        ...
        {
            get => (JsConfigScope.Current?.ParsePrimitiveFn)
                   ?? sParsePrimitiveFn
                   ?? null;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.DateHandler)
                   ?? sDateHandler
        ...
        {
            get => (JsConfigScope.Current?.TimeSpanHandler)
                   ?? sTimeSpanHandler
        ...
        public static bool EmitCamelCaseNames
        {
            ...
            get => (JsConfigScope.Current?.EmitCamelCaseNames)
                   ?? sEmitCamelCaseNames
                   ?? false;
            set
            {
        ...
        {
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            get => (JsConfigScope.Current?.EmitLowercaseUnderscoreNames)
        ...
        {
            get => (JsConfigScope.Current?.PropertyConvention)
                   ?? sPropertyConvention
        ...
        {
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            get => (JsConfigScope.Current?.ThrowOnDeserializationError)
        ...
        {
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            get => (JsConfigScope.Current?.AlwaysUseUtc)
                   ?? sAlwaysUseUtc
                   ?? false;
            set
            {
        ...
        {
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            get => (JsConfigScope.Current?.SkipDateTimeConversion)
        ...
        {
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            get => (JsConfigScope.Current?.AssumeUtc)
                   ?? sAssumeUtc
                   ?? false;
            set
            {
        ...
        {
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            get => (JsConfigScope.Current?.AppendUtcOffset)
                   ?? sAppendUtcOffset
                   ?? null;
            set
            {
        ...
        {
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            get => (JsConfigScope.Current?.EscapeUnicode)
                   ?? sEscapeUnicode
                   ?? false;
            set
            {
        ...
        {
            // obeying the use of ThreadStatic, but allowing for setting JsConfig once as is the normal case
            get => (JsConfigScope.Current?.EscapeHtmlChars)
                   ?? sEscapeHtmlChars
                   ?? false;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.OnDeserializationError)
        ...
        {
            get => (JsConfigScope.Current?.PreferInterfaces)
                   ?? sPreferInterfaces
                   ?? false;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.IncludePublicFields)
        ...
        {
            get => (JsConfigScope.Current?.MaxDepth)
                   ?? sMaxDepth
                   ?? int.MaxValue;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.ModelFactory)
                   ?? sModelFactory
                   ?? null;
            set
            {
        ...
        {
            get => (JsConfigScope.Current?.ExcludePropertyReferences)
        ...
        {
            get => (JsConfigScope.Current?.ExcludeTypes)
                   ?? sExcludeTypes;
            set
            {
